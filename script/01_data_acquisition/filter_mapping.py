...
MIN_LINK_END_DATE = '2008-01-01'


def filter_mapping_data():
    BASE_DIR = os.path.dirname(os.path.abspath(__file__))
    input_path = os.path.abspath(os.path.join(BASE_DIR, '../../raw_data/cik_ticker_permno_mapping.csv'))
    ...
    try:
        ...
        # Filter for links active through the 2008-2022 research window
        df_filtered = df[df['linkenddt_parsed'] >= pd.to_datetime(MIN_LINK_END_DATE)].copy()
